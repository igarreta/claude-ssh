...
window. **Cold-spare third drive picked 2026-09-26**: HGST Ultrastar 7K6000, eBay $103.73
(seller-refurbished, not mfr-recert — acceptable for a shelved spare, not the mirror), Toshiba
...
- [2026-08-20_nas-disk-prices-and-raid-options.md](2026-08-20_nas-disk-prices-and-raid-options.md) — *active* — prices, RAID layouts, recert sourcing. **Corrects §5/§9 of the 08-19 doc**; itself **corrected 2026-09-07 and again 2026-09-08** on the F4-425 Plus RAM (16 GB is the N150 SKU). Verify stock before ordering. **§11 added 09-26**: cold-spare third drive picked (HGST Ultrastar 7K6000, eBay); local MercadoLibre alternative rejected (no warranty, low-reputation seller)
