...
- [project_zigbee_lqi_collector.md](project_zigbee_lqi_collector.md) — LQI/route-error CSVs on CT206; it parses log text, so a `log_level` change rescales the counts — pre-09-13 route errors are inflated ~3-4x
