...
- [project_docker03_decommission.md](project_docker03_decommission.md) — VM 102 stopped since 09-06 and not in use, in cooldown; don't start it casually, and `onboot: 1` still resurrects it on a host reboot
