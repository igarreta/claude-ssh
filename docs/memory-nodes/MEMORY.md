...
- [project_nas.md](project_nas.md) — chassis decided 09-10: **F4-424 Pro** (i3-N305 8c, 32 GB), $687, total $1,121.90; the 09-08 N150 pick rested on a $479.99 price that never existed; cold-spare drive picked 09-26 (eBay HGST Ultrastar 7K6000); local alternative rejected
...
- [project_contabo2_openclaw-heartbeat-cost.md](project_contabo2_openclaw-heartbeat-cost.md) — openclaw's 20-min heartbeat drove ~$1/day Haiku cost since 08-11; disabled via `config unset`
...
- [project_raspberrypi1_psu-replacement.md](project_raspberrypi1_psu-replacement.md) — PSU swapped 09-20 after sticky under-voltage flags; confirmed resolved 09-26
