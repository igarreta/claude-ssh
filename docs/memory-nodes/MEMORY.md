...
- [project_mosquitto_broker_migration.md](project_mosquitto_broker_migration.md) — new broker LXC 105 live; all 7 known clients cut over (incl. esp32-pileta, found late); brief full outage 08-26 from a bad chown
